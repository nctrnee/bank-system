...
def create_new_account():
    ...
    if not is_user_willing("Continue creating account?"):  # Handle mistyped
        return
    ...
    # Unpacking: distributing the values to variables
    (
        last_name,
        first_name,
        middle_name,
...
def log_in():
    ...
    if not is_user_willing("Continue logging in?"):
        return
    ...
    first_name = data[account_number]["Personal Information"]["First name"]
    if not is_password_valid(account_number):
        return
